...
import { Dimensions,PanResponder,StyleSheet,View,Text } from 'react-native';
    ...
    renderLandscape() {
        return (
            <View style={{flex:1, paddingTop: 50}}>
                <Text style={{color:"white" , fontSize:50}}>Please Use portrait for better experience!</Text>
            </View>
        )
    }

    render() {
        var view = (this.state.orientation == "portrait") ? this.renderProtrait() : this.renderLandscape();
        return(
